...
> **本项目基于 [YufengJin/paper-snapshots](https://github.com/YufengJin/paper-snapshots)**
> （原站点 <https://yufengjin.github.io/paper-snapshots/>）的项目骨架与工作流。
> 感谢原作者 **YufengJin** 的开源工作（MIT License）。本仓库为个人 fork，论文海报内容已清空、由本人自行维护。

本仓库是 **Paper Notes**：我读过论文的中文图文海报合集，作为独立 GitHub Pages 项目站点发布。
